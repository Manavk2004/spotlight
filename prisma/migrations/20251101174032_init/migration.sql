-- CreateEnum
CREATE TYPE "WebinarStatusEnum" AS ENUM ('LIVE', 'ENDED', 'CANCELLED', 'SCHEDULED');

-- CreateEnum
CREATE TYPE "CtaTypeEnum" AS ENUM ('BUY_NOW', 'BOOK_A_CALL');

-- CreateEnum
CREATE TYPE "AttendedTypeEnum" AS ENUM ('REGISTERED', 'ATTENDED', 'ADDED_TO_CART', 'FOLLOW_UP', 'CONVERTED');
...
-- CreateIndex
CREATE INDEX "Attendance_wbeinarId_idx" ON "Attendance"("wbeinarId");

-- CreateIndex
CREATE UNIQUE INDEX "Attendance_attendeeId_wbeinarId_key" ON "Attendance"("attendeeId", "wbeinarId");
...
-- AddForeignKey
ALTER TABLE "Attendance" ADD CONSTRAINT "Attendance_wbeinarId_fkey" FOREIGN KEY ("wbeinarId") REFERENCES "Webinar"("id") ON DELETE CASCADE ON UPDATE CASCADE;
