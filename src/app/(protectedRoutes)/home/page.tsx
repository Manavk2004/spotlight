...
import { potentialCustoemrs, potentialCustomers } from '@/lib/data'
import UserInfoCard from '@/components/ReusableComponents/UserInfoCard'

type Props = {}

function Pages({ props } : { props: Props}) {
  return (
    <div className='w-full mx-auto h-full'>
        <div className='w-full flex flex-col sm:flex-row justify-between items-start gap-14 mt-10'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-6 place-content-center'>
                <FeatureCard
                    ...
                    heading="Browse or drage a pre-recored webinar file"
                    link="#"
                />
                <FeatureCard
            ...
            >
                <div className='flex gap-4 items-center h-full w-full justify-center relative flex-wrap'>
                    ...
                    <Image 
                        ...
                        width={350}
                        height={350}
                        className='object-cover rounded-xl absolute px-5 mb-28 hideen sm:flex backdrop-blur-[20px]'
                    />
                </div>
            </FeatureSectionLayout>
        </div>
